 ...
 */
export function getAccountIcon(accountType: string | undefined | null, withColors = false): React.ReactElement {
 ...
 */
export function getConnectionStatusIcon(status: string): React.ReactElement {
  switch (status) {
    case 'healthy':
 ...
 */
export function getReconciliationStatusIcon(isReconciled: boolean, discrepancy: number): React.ReactElement {
  if (isReconciled) {
 ...
 */
export function getHealthIcon(health?: string): React.ReactElement {
  switch (health) {
    case 'healthy':

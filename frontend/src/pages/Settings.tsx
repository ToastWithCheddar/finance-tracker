...
export function Settings() {
  ...
  const updatePreference = (key: keyof UserPreferences, value: string | number | boolean) => {
    ...
    const errors = userPreferencesService.validatePreferences(newFormData);
  ...
  return (
    <div className="min-h-screen py-8" style={{ backgroundColor: 'hsl(var(--bg))', color: 'hsl(var(--text))' }}>
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[hsl(var(--text))]">Settings</h1>
          <p className="mt-2 text-[hsl(var(--text))] opacity-70">Manage your account preferences and settings</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <div className="p-6">
              <h2 className="text-xl font-semibold text-[hsl(var(--text))] mb-4">Display Preferences</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Currency</label>
                  <select
                    value={formData.currency || ''}
                    onChange={(e) => updatePreference('currency', e.target.value)}
                    className="w-full px-3 py-2 rounded-lg focus:ring-2 border bg-[hsl(var(--surface))] border-[hsl(var(--border))] text-[hsl(var(--text))] focus:ring-[hsl(var(--brand))] focus:border-[hsl(var(--brand))]"
                  >
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Theme</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Date Format</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Items per Page</label>
                  <Input
                    type="number"
                    min="10"
                    max="100"
          ...
          <Card>
            <div className="p-6">
              <h2 className="text-xl font-semibold text-[hsl(var(--text))] mb-4">Notifications</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={key} className="flex items-center justify-between">
                    <div>
                      <div className="font-medium text-[hsl(var(--text))]">{label}</div>
                      <div className="text-sm text-[hsl(var(--text))] opacity-70">{description}</div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className="w-11 h-6 rounded-full peer bg-[hsl(var(--border))] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[hsl(var(--brand))] peer-checked:bg-[hsl(var(--brand))] after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:dark:bg-gray-200 after:border after:border-[hsl(var(--border))] after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full"></div>
                    </label>
                  </div>
                ))}
              </div>
          ...
          <Card>
            <div className="p-6">
              <h2 className="text-xl font-semibold text-[hsl(var(--text))] mb-4">Financial Settings</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Default Account Type</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Budget Warning Threshold (%)</label>
                  <Input
                    type="number"
                    min="0.1"
                    max="1"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Low Balance Threshold</label>
                  <Input
                    type="number"
                    min="0"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Startup Page</label>
                  <select
              ...
              <div className="mt-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-[hsl(var(--text))] opacity-80">Automatically categorize transactions</span>
                </label>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="p-6">
              <h2 className="text-xl font-semibold text-[hsl(var(--text))] mb-4">Privacy & Backup</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-[hsl(var(--text))]">Data Sharing</div>
                    <div className="text-sm text-[hsl(var(--text))] opacity-70">Allow anonymous data sharing for product improvement</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-[hsl(var(--text))]">Auto Backup</div>
                    <div className="text-sm text-[hsl(var(--text))] opacity-70">Automatically backup your data</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-[hsl(var(--text))] opacity-80">Backup Frequency</label>
                  <select
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-4">
              ...
              <Button
                ...
                disabled={isBusy || !hasChanges || validationErrors.length > 0}
              >
